...
const insertInToDB = (authId, data) => __awaiter(void 0, void 0, void 0, function* () {
    data.userId = authId;
    const result = yield prisma_1.default.booking.create({ data });
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to create Booking');
    }
    return result;
});
...
const updateInToDB = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.default.booking.findFirst({ where: { id } });
    if (!isExist) {
...
const getMyBookings = (authId, filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } = paginationHelper_1.paginationHelpers.calculatePagination(options);
...
const cancelMyBooking = (authId, id) => __awaiter(void 0, void 0, void 0, function* () {
