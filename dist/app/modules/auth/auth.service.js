...
const userSignIn = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { password } = newUser, others = __rest(newUser, ["password"]);
    return others;
});
const userLogin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, password } = payload;
    const isUserExist = yield (0, user_utils_1.checkIsUserExist)(email);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User does not exist');
    }
    if (isUserExist.password &&
        !(yield (0, user_utils_1.checkIsPasswordMatched)(password, isUserExist.password))) {
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield (0, user_utils_1.checkIsUserExist)(userId);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User does not exist');
    }
    //generate new token
