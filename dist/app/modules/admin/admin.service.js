...
const getAllAdmins = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const whereConditions = andConditions.length > 0
        ? { AND: [...andConditions, { role: user_1.ENUM_USER_ROLE.ADMIN }] }
        : { role: user_1.ENUM_USER_ROLE.ADMIN };
...
const updateAdmin = (authRole, id, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (authRole !== user_1.ENUM_USER_ROLE.SUPER_ADMIN && (data === null || data === void 0 ? void 0 : data.role)) {
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, 'You are not authorized to change user role');
    }
